...
describe UsersController do
  ...
  describe "PUT 'update'" do
    ...
    describe "success" do
      ...
      before(:each) do
        @attr = { :name => "Updated Name", :email => "updt_user@example.com",
  ...
  describe "DELETE 'destroy'" do
    ...
    describe "as an admin user" do
      ...
      describe "who is destroying him/herself" do
        before(:each) do
          test_sign_in(@user)
          @user.toggle!(:admin)
        end
        
        it "should prevent them" do |variable|
          lambda do
            delete :destroy, :id => @user
            flash[:notice].should =~ /admin users may not delete themselves/i
          end.should_not change(User, :count)
        end
      end
